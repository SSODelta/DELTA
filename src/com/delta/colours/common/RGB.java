...
public final class RGB extends Colour {
	...
	/**
	 * Constructs a new RGB Colour object.
	 * @param r Red
	 * @param g Green
	 * @param b Blue
	 */
	...
	/**
	 * Converts an RGB Colour object to an HSV Colour object.
	...
	/**
	 * Converts an RGB Colour object to an HSI Colour object.
	 * Uses the algorithm detailed at
	 * 
	 * 	http://www.had2know.com/technology/hsi-rgb-Colour-converter-equations.html
	 * 
	 */
	@Override
	public HSI toHSI() {
		double r = get('r'),
			   ...
			   m = ColourUtil.min(r, g, b),
			   S = I > 0 ? 1 - m/I : 0,
			   hh = ColourUtil.acos( (r - 0.5*g - 0.5*b) / Math.sqrt(r*r + g*g + b*b - r*g - r*b - g*b));
		
		return new HSI(b > g ? 360-hh : hh,S,I);
	}

	/**
	 * Converts an RGB Colour object to an HCY (Hue Chroma Luma) Colour object.
	...
	public HCY toHCY() {
		...
		double C = ColourUtil.max(r,g,b) - ColourUtil.min(r,g,b);
	...
	/**
	 * Convert this RGB Colour object to a CMYK Colour Object.
	 * Uses the formulae at this website:
	 * 
	 * 	http://www.rapidtables.com/convert/Colour/rgb-to-cmyk.htm
	 */
	@Override
	public CMYK toCMYK() {
		double r = get('r'),
	...
	/**
	 * Converts this RGB Colour object to a YUV Colour object.
